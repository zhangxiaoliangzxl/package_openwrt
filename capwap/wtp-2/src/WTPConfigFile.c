...
CWBool CWConfigFileInitLib() {
	...
	gConfigValues[5].type = CW_INTEGER;
	gConfigValues[5].code = "</AP_CARD_COUNT>";
	gConfigValues[5].value.str_value = 0;
...
CWBool CWConfigFileDestroyLib() {
	...
	gCWACCfg->gCWACCount = gConfigValues[0].count;
	...
	gCWAPCardCount = gConfigValues[5].value.int_value;
