...
CWBool CWAssembleMsgElemWTPVendorSpecificPayloadWTPMAC(CWProtocolMessage *msgPtr, int offset);			//37
...
CWBool CWAssembleMsgElemEchoRequest(CWProtocolMessage *msgPtr);
