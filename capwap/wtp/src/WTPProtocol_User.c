...
__inline__ int CWWTPGetRadiosInUse() 
{
	...
	return active;
	*/
	return gWtpPublicInfo.cardnum;//gRadiosInfo.radioCount;
}
...
CWBool CWWTPGetACNameWithIndex (CWACNamesWithIndex *ACsInfo)
{
	...
	CW_CREATE_STRING_FROM_STRING_ERR((ACsInfo->ACNameIndex)[0].ACName, "ebi.ac", return CWErrorRaise(CW_ERROR_OUT_OF_MEMORY, NULL););
