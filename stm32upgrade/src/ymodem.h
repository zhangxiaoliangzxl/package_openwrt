...
#define BOOT_NO_ACK 0xFFFF0014
#define USR_CAN 0xFFFF0015
#define NO_COMPLETED_ACK 0xFFFF0016
...
#define SLEEP(a) sleep(a * 1000) // sleep s

#define ERROR_LOG "/tmp/stm32upgrade.log"
